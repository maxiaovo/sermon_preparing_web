...
This file is loaded by Codex on every session start. All rules here are **mandatory** and must be followed without exception.
...
### Author
- Author must always be **maxiaovo**. Never use `Codex`, `ttmanthatman`, or any other name.
...
| 6 | **Reuse Search** | Search npm, GitHub, Codex skills for existing solutions before building |
...
- Check in this order: Codex skills, npm packages, open-source GitHub projects, prior project code.
